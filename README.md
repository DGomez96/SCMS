...
Proyecto de CMS y CRM , un proyecto sobre una Tienda.
...
2. Mostrar Productos
   * Recorrer Productos y printarlos en la parte Tienda.
   * Añadir un Modal para una forma de Añadir mas Rápdia
   * Añadir una página adicional de información del producto
