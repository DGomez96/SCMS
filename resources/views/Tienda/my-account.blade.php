...
@section("contenido")
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <nav class="woocommerce-breadcrumb">
                                ...
                                <span class="separator">/</span> Novedades
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="entry-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h1 class="entry-title">Bienvenido {{ $usuario->name }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="account-text-wrapper">
                        ...
                        <div class="col-md-3">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="#download" data-toggle="tab"><i class="fa fa-cloud-download"></i> Descargas</a>

                                <a href="#payment-method" data-toggle="tab"><i class="fa fa-credit-card"></i> Metodo de Pago</a>

                                <a href="#address-edit" data-toggle="tab"><i class="fa fa-map-marker"></i> address</a>

                                <a href="#account-info" data-toggle="tab"><i class="fa fa-user"></i> Detalles de la Cuenta</a>

                                <a class="logout"  href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Cerrar Sesion</a>
