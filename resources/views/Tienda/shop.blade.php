                                                ...
                                                <div class="single-product-area">
                                                    <div class="product-wrapper gridview">
                                                        <div class="list-col4">
                                                            <div class="product-image">
                                                                <a href="">
                                                                    <img src="storage/{{$imagenes[$indice]['img']}}" alt="">
                                                                </a>
                                                                <div class="quickviewbtn">
                                                                    <a href="#" onclick="verProducto({{$producto}},'{{$imagenes[$indice]['img']}}')"><i class="ion-eye"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="list-col8">
                                                            <div class="product-info">
                                                                <h2><a href="single-product.html">{{$producto->name}}</a></h2>
                                                                <span class="price">
                                                        ...
                                                        <div class="list-col8">
                                                            <div class="product-info">
                                                                ...
                                                                <div class="product-desc">
                                                                    <p id="descripcionProducto-{{$producto->id}}"></p>
                                                                </div>
                                                            </div>
                                                            <div class="actions-wrapper">
                                                                ...
                                                                <div class="star-actions">
                                                                    <ul class="actions">
                                                                        <li><a href=""><i class="ion-android-favorite-outline"></i>Añadir a lista de deseos</a></li>
                                                                        <li><a href=""><i class="ion-ios-shuffle-strong"></i>Comparar</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
