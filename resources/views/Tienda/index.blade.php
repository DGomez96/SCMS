							...
							<div class="slider-area-inner">
								...
								<div class="slider-inner">
									<div id="mainSlider" class="nivoSlider nevo-slider">
										<img src="images/slider/Iphone11.png" alt="main slider" title="#htmlcaption1"/>
										<img src="images/slider/xiaominote10.png" alt="main slider" title="#htmlcaption2"/>
									</div>	
									<div id="htmlcaption1" class="nivo-html-caption slider-caption">
										...
										<div class="col-md-9">
											<div class="slider-content slider-content-1 slider-animated-1">
												<h1 class="hone">Iphone 11</h1>
												<h1 class="htwo">Innovación</h1>
												<h3 class="h3two">Conocimiento en tus manos</h3> 
												<div class="button-1 hover-btn-2">
													<a href="shop.html">Ver Producto</a>
												</div>
											</div>
										</div>
									</div>
									<div id="htmlcaption2" class="nivo-html-caption slider-caption">
										...
										<div class="col-md-9">
											<div class="slider-content slider-content-2 slider-animated-2">
												<h1 style="-webkit-text-stroke: 2px black;" class="hone">Mi Note 10</h1>
												<h1 style="-webkit-text-stroke: 2px black;" class="htwo">Empieza algo grande</h1>
												<h3 style="-webkit-text-stroke: 2px black;" class="h3one">El primer smartphone con 108 MP y 5 cámaras </h3>
												<h3 style="-webkit-text-stroke: 2px black;" class="h3two">549€</h3>
                                        ...
                                        <div class="product-wrapper gridview">
                                            <div class="list-col4">
                                                <div class="product-image">
                                                    <a href="#">
                                                        <img src="images/product/alcatel.jpg" alt="">
                                                    </a>
                                            ...
                                            <div class="list-col8">
                                                <div class="product-info">
                                                    <h2><a href="single-product.html">Alcatel</a></h2>
                                                    <span class="price">
                                                        XXXX
                                                    </span>
                                                </div>
                                                <div class="product-hidden">
                                                    <div class="add-to-cart">
                                                        <a href="cart.html">Añadir al Carrito</a>
                                                    </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="single-product-area">
                                        <div class="product-wrapper gridview">
                                            ...
                                            <div class="list-col8">
                                                <div class="product-info">
                                                    <h2><a href="single-product.html">ALCATEL 2053D WHITE</a></h2>
                                                    <span class="price">
                                                        <del> 77.00 €</del> 66.00 €
                                                    </span>
                                                </div>
